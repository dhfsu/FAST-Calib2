#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Vendored from UMI-3D (sensors_calibration/fisheye_intrinsics/calibrate_fisheye_intrinsics.py).
# Outputs calib_output/equidistant.yaml with fx, fy, cx, cy and k1..k4 -- paste those
# into config/qr_params.yaml together with "camera_model: fisheye" and the raw image
# resolution used here (camera_width/camera_height).
"""
